...
\* `-16` (decimal do complemento assinado de 2) — leia mais sobre a [Two's complement](https://en.wikipedia.org/wiki/Two%27s_complement) operation (operação de complemento de dois).
